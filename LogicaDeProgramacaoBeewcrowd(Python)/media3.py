...
##média acompanhada pela mensagem "Media: ". Se esta média for maior ou
##igual a 7.0, imprima a mensagem "Aluno aprovado.". Se a média calculada
...
##exame com a média anteriormente calculada e divida por 2). e imprima
##a mensagem "Aluno aprovado." (caso a média final seja 5.0 ou mais )
##ou "Aluno reprovado.", (caso a média tenha ficado 4.9 ou menos). Para
##estes dois casos (aprovado ou reprovado após ter pego exame) apresente
##na última linha uma mensagem "Media final: " seguido da média final para
##esse aluno.
##
##Entrada
...
##esqueça de imprimir o enter após o final de cada linha, caso contrário
...
if media >= 7.0:
    ...
    if media >= 5.0 and media <= 6.9:
        ...
        nota = input()
        nota = float(nota)
        print(f"Nota do exame: {nota:.2}")
        media = (media + nota) / 2
        if media >= 5.0:
           print("Aluno aprovado.")
           print(f"Media final: {media:.2}")
        if media <= 4.9:
           print("Aluno reprovado.")
           print(f"Media final: {media:.2}")
